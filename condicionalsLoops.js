...
if (age >= 18) {
  console.log("Eres mayour de edad");
} else {
...
const result = (weather == "soleado") ? "Me vestire con un vestido" : "Me vestire con pantalo";
console.log(result); 

//Ejercicio 7: cambia el valor de weather a "frío" y mira el resultado en consola para comprobar que tu código funciona bien.
const weather2 = "frio";
const result2 = (weather2 == "soleado") ? "Me vestire con un vestido" : "Me vestire con pantalon";
console.log(result2); 
...
for (let j = 0; j < programmers.length; j++) {
    console.log(j + ": " + programmers[j].name + " " + programmers[j].lastname + ", su aporte fue" + programmers[j].knowledge);
}

for (let coder of programmers) {
    console.log(coder+" "+coder.name+" "+coder.lastname+" "+coder.knowledge);
}
...
for (let k = 0; k < names.length; k++) {
    console.log("Hola mi nombre es: "+names[k]);
